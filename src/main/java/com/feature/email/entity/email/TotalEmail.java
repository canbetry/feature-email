...
@Data
@ApiModel("邮件总表")
public class TotalEmail extends CommonEntity {
    ...
    private String reciveUserRealAddr;  //收件人真实地址,如果未填写地址那么默认为'寄件人选择网络邮箱收件'
    ...
    private String isSend;              //邮件是否发送：未发送、已发送,默认未发送
}
